...
<body>
	...
	<div class="container">
		<div class="panel panel-default">
			<div style="font-weight: bold;" class="panel-heading">用户登錄</div>
			<div class="row">
				...
				<div class="panel-body col-md-6 col-xs-12" id="logins">
					<form class="form-horizontal" style="text-align: center;"
						...
						method="post">
						<p class="p_title">請登錄！</p>
						<div class="form-group">
							<span>帳&emsp;&emsp;號：</span><input type="text" id="username" name="userName" value="${formbean.userName}" placeholder="請輸入帳號">${formbean.errors.userName}

						</div>
						<div class="form-group">
							<span>密&emsp;&emsp;碼： </span><input type="password" id="psd" name="userPwd"
								placeholder="請輸入密碼">

						</div>
						<div>
							<button type="submit" class="btn btn-success">登&emsp;錄</button>
...
<script src="bootstrap/3.3.0/jquery-3.3.1.slim.js"></script>
